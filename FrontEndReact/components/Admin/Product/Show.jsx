...
const Show = () => {
  ...
  const [products, setProducts] = useState([]);
      ...
      const fetchProducts = async () =>{
          setLoader(true)
          const rest = fetch(`${apiUrl}/products`,{
              method: 'GET',
              headers: {
       ...
       const deleteProduct = async(id) =>{
                            if(confirm("Are you sure you want to delete ?")){
                              ...
                              const rest = await fetch(`${apiUrl}/products/${id}`,{
                                      method: 'DELETE',
                                      headers: {
                                          'Content-type' : 'application/json',
                                          'Accept' : 'application/json',
                            ...
                            products.map(product =>{
                             return (
                                <tr>
                                  ...
                                  <td>
                                     {
                                    (product.image_url == "") ? <img src="https://placehold.co/50x50"/> : <img src={product.image_url} alt="" width={70}></img>
                                     }                                    
                                  </td>
                                  <td>{product.title}</td>
                                  <td>{product.price}</td>
