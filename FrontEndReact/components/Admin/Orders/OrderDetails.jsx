...
const OrderDetails = () => {
    ...
    const fetchOrders = async () =>{
            setLoader(true)
            const rest = fetch(`${apiUrl}/orders/${params.id}`,{
                method: 'GET',
                headers: {
    ...
    const updateOrder = async (data) =>{
        ...
        const rest = fetch(`${apiUrl}/update-order/${params.id}`,{
                method: 'POST',
                headers: {
                    'Content-type' : 'application/json',
                    'Accept' : 'application/json',
        ...
        <div className='container'>
          <div className='row'>
            <div className="d-flex justify-content-between mt-5 pb-3">
              <h4 className="h4 pb-0 mb-0">Your Titles</h4>
                                ...
                                <div key={`${item.id}`} class="row justify-content-end">
                                    <div class="col-lg-12">
                                        <div class="d-flex justify-content-between border-bottom pb-2 mb-2">
                                            <div class="d-flex">
                                                {
                                                    item.product.image && <img width= "70" className='me-3'
