              ...
              const saveOrder = (formData, paymentStatus) =>{
                ...
                .then(result =>{
                    ...
                    if(result.status == 200){
                        ...
                        navigate(`/order/confirmations/${result.id}`)
                    }else {
                ...
                <div className='col-md-7'>
                    ...
                    <div className='row pt-3'>
                        ...
                        <div className='mb-3'>
                            ...
                            className={`form-control ${errors.address && 'is-invalid'}`} rows={3} placeholder='Adress'></textarea>
                             {
                  ...
                  <div className='col-md-5'>
                    ...
                    <div>
                        <input type="radio" onChange={handlePaymentMethod} checked={paymentMethod=='stripe'} value={'stripe'}/>
                    ...
                    <div className='d-flex py-3'>
                                <button disabled={loading} className='btn btn-primary'>{loading ? 'Please Wait...' : 'Pay Now'}</button>
                            </div>
